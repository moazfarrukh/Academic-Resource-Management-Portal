...
function ResourceDetail() {
    ...
    const handlePostComment = async ()=>{
        await axios.post('http://localhost:3001/resource/addComment', {
            id:resource._id,
            ...
            <section  style={{marginLeft:"16%"}}>
                ...
                <div className={appendThemeToClassNames("resourceFooter")}>
                    ...
                    <div className={appendThemeToClassNames("resourceAddComment")}>
                        <textarea value={addComment} placeholder="Add your comment here!" rows="4" onChange={(e)=>{setAddComment(e.target.value)}}></textarea><br></br>
